...
_reactDom2.default.render(React.createElement(_index2.default, null), document.getElementById('root'));
...
var MultiplierCalculator = function (_React$Component) {
    ...
    function MultiplierCalculator(props) {
        _classCallCheck(this, MultiplierCalculator);

        var _this = _possibleConstructorReturn(this, (MultiplierCalculator.__proto__ || Object.getPrototypeOf(MultiplierCalculator)).call(this, props));
        ...
        _this.handleTypeOfGameChange = _this.handleTypeOfGameChange.bind(_this);
        _this.handleColorChange = _this.handleColorChange.bind(_this);
        _this.switchCard = _this.switchCard.bind(_this);
        return _this;
    }

    _createClass(MultiplierCalculator, [{
        key: 'handleTypeOfGameChange',
        value: function handleTypeOfGameChange(event) {
            this.setState({
        ...
        value: function getPeakProgressClassNames() {
            return (0, _classnames2.default)('progress', {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.state.typeOfGame === 'color' && _react2.default.createElement(
                    'div',
                    { className: 'columns' },
                    _react2.default.createElement(
                        'div',
                ...
                this.state.typeOfGame === 'grand' && _react2.default.createElement(
                    'div',
                    { className: 'columns' },
                    _react2.default.createElement(
                        'div',
...
exports.default = MultiplierCalculator;
